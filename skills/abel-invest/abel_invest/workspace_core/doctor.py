    ...
    result.update(
        {
            ...
            "next_step": (
                ...
                "# runs live graph discovery; then init a scout/candidate branch -> prepare-branch -> first-look scout with roughly 5-minute expected runtime before any broad run"
            ),
        }
    )
    return result
