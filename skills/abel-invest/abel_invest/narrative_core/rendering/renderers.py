...
def build_agent_context(
    *,
    ...
    path_status = build_exploration_path_status(session)
...
{render_agent_context_exploration_path(path_status)}
...
def render_agent_context_exploration_path(status: dict[str, object]) -> str:
    lines = [
