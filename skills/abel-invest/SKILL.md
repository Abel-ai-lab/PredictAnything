...
14. Do not call parameter, sizing, threshold, filter, or window tweaks broad
    exploration.
15. Standard discovery chooses branches from graph context, mechanism
...
16. Treat `--selection-trials` as DSR audit and penalty accounting, not as
    permission to use brute-force candidate selection in standard discovery.
17. Treat user metric targets such as Sharpe thresholds as success criteria, not
